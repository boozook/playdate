...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
	["Size of PlaydateGraphics"][::core::mem::size_of::<PlaydateGraphics>() - 252usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
	["Size of PlaydateSoundSignal"][::core::mem::size_of::<PlaydateSoundSignal>() - 20usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
	["Size of PlaydateSoundSynth"][::core::mem::size_of::<PlaydateSoundSynth>() - 116usize];
...
pub struct PlaydateSoundTrack {
	...
	#[doc = "\n<code class=\"title\">int playdate-&gt;sound-&gt;track-&gt;getLength(SequenceTrack* track)</code>\n<div class=\"content\">\n<div class=\"paragraph\">\n<p>Returns the length, in steps, of the track—\u{200b}that is, the step where the last note in the track ends.</p>\n</div>\n</div>\n"]
