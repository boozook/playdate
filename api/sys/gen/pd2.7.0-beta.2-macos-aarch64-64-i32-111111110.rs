...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
	["Size of playdate_graphics"][::core::mem::size_of::<playdate_graphics>() - 520usize];
	...
	["Offset of field: playdate_graphics::videostream"]
		[::core::mem::offset_of!(playdate_graphics, videostream) - 512usize];
};
...
pub struct playdate_http {
	...
	pub setHeaderReceivedCallback:
		::core::option::Option<unsafe extern "C" fn(connection: *mut HTTPConnection, header: HTTPHeaderCallback)>,
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
	["Size of playdate_http"][::core::mem::size_of::<playdate_http>() - 168usize];
	...
	["Offset of field: playdate_http::setKeepAlive"]
		[::core::mem::offset_of!(playdate_http, setKeepAlive) - 32usize];
	["Offset of field: playdate_http::setByteRange"]
		[::core::mem::offset_of!(playdate_http, setByteRange) - 40usize];
	["Offset of field: playdate_http::setUserdata"][::core::mem::offset_of!(playdate_http, setUserdata) - 48usize];
	["Offset of field: playdate_http::getUserdata"][::core::mem::offset_of!(playdate_http, getUserdata) - 56usize];
	["Offset of field: playdate_http::get"][::core::mem::offset_of!(playdate_http, get) - 64usize];
	["Offset of field: playdate_http::post"][::core::mem::offset_of!(playdate_http, post) - 72usize];
	["Offset of field: playdate_http::getError"][::core::mem::offset_of!(playdate_http, getError) - 80usize];
	["Offset of field: playdate_http::getProgress"][::core::mem::offset_of!(playdate_http, getProgress) - 88usize];
	["Offset of field: playdate_http::getResponseStatus"]
		[::core::mem::offset_of!(playdate_http, getResponseStatus) - 96usize];
	["Offset of field: playdate_http::getBytesAvailable"]
		[::core::mem::offset_of!(playdate_http, getBytesAvailable) - 104usize];
	["Offset of field: playdate_http::setReadTimeout"]
		[::core::mem::offset_of!(playdate_http, setReadTimeout) - 112usize];
	["Offset of field: playdate_http::read"][::core::mem::offset_of!(playdate_http, read) - 120usize];
	["Offset of field: playdate_http::close"][::core::mem::offset_of!(playdate_http, close) - 128usize];
	["Offset of field: playdate_http::setHeaderReceivedCallback"]
		[::core::mem::offset_of!(playdate_http, setHeaderReceivedCallback) - 136usize];
	["Offset of field: playdate_http::setHeadersReadCallback"]
		[::core::mem::offset_of!(playdate_http, setHeadersReadCallback) - 144usize];
	["Offset of field: playdate_http::setRequestCompleteCallback"]
		[::core::mem::offset_of!(playdate_http, setRequestCompleteCallback) - 152usize];
	["Offset of field: playdate_http::setConnectionClosedCallback"]
		[::core::mem::offset_of!(playdate_http, setConnectionClosedCallback) - 160usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
	["Size of playdate_tcp"][::core::mem::size_of::<playdate_tcp>() - 88usize];
	...
	["Offset of field: playdate_tcp::close"][::core::mem::offset_of!(playdate_tcp, close) - 40usize];
	["Offset of field: playdate_tcp::setConnectionClosedCallback"]
		[::core::mem::offset_of!(playdate_tcp, setConnectionClosedCallback) - 48usize];
	["Offset of field: playdate_tcp::getBytesAvailable"]
		[::core::mem::offset_of!(playdate_tcp, getBytesAvailable) - 56usize];
	["Offset of field: playdate_tcp::setReadTimeout"]
		[::core::mem::offset_of!(playdate_tcp, setReadTimeout) - 64usize];
	["Offset of field: playdate_tcp::read"][::core::mem::offset_of!(playdate_tcp, read) - 72usize];
	["Offset of field: playdate_tcp::write"][::core::mem::offset_of!(playdate_tcp, write) - 80usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone, Hash, PartialOrd, Ord, PartialEq, Eq)]
#[must_use]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
	["Size of playdate_network"][::core::mem::size_of::<playdate_network>() - 16usize];
