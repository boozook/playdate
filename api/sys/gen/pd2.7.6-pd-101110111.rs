...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
	["Size of PlaydateVideoStream"][::core::mem::size_of::<PlaydateVideoStream>() - 44usize];
	["Alignment of PlaydateVideoStream"][::core::mem::align_of::<PlaydateVideoStream>() - 4usize];
	...
	["Offset of field: PlaydateVideoStream::freePlayer"]
		[::core::mem::offset_of!(PlaydateVideoStream, freePlayer) - 4usize];
	["Offset of field: PlaydateVideoStream::setBufferSize"]
		[::core::mem::offset_of!(PlaydateVideoStream, setBufferSize) - 8usize];
	["Offset of field: PlaydateVideoStream::setFile"]
		[::core::mem::offset_of!(PlaydateVideoStream, setFile) - 12usize];
	["Offset of field: PlaydateVideoStream::setHTTPConnection"]
		[::core::mem::offset_of!(PlaydateVideoStream, setHTTPConnection) - 16usize];
	["Offset of field: PlaydateVideoStream::getFilePlayer"]
		[::core::mem::offset_of!(PlaydateVideoStream, getFilePlayer) - 20usize];
	["Offset of field: PlaydateVideoStream::getVideoPlayer"]
		[::core::mem::offset_of!(PlaydateVideoStream, getVideoPlayer) - 24usize];
	["Offset of field: PlaydateVideoStream::update"]
		[::core::mem::offset_of!(PlaydateVideoStream, update) - 28usize];
	["Offset of field: PlaydateVideoStream::getBufferedFrameCount"]
		[::core::mem::offset_of!(PlaydateVideoStream, getBufferedFrameCount) - 32usize];
	["Offset of field: PlaydateVideoStream::getBytesRead"]
		[::core::mem::offset_of!(PlaydateVideoStream, getBytesRead) - 36usize];
	["Offset of field: PlaydateVideoStream::setTCPConnection"]
		[::core::mem::offset_of!(PlaydateVideoStream, setTCPConnection) - 40usize];
};
#[repr(C)]
#[must_use]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
	["Size of PlaydateTilemap"][::core::mem::size_of::<PlaydateTilemap>() - 44usize];
	["Alignment of PlaydateTilemap"][::core::mem::align_of::<PlaydateTilemap>() - 4usize];
	...
	["Offset of field: PlaydateTilemap::freeTilemap"]
		[::core::mem::offset_of!(PlaydateTilemap, freeTilemap) - 4usize];
	["Offset of field: PlaydateTilemap::setImageTable"]
		[::core::mem::offset_of!(PlaydateTilemap, setImageTable) - 8usize];
	["Offset of field: PlaydateTilemap::getImageTable"]
		[::core::mem::offset_of!(PlaydateTilemap, getImageTable) - 12usize];
	["Offset of field: PlaydateTilemap::setSize"][::core::mem::offset_of!(PlaydateTilemap, setSize) - 16usize];
	["Offset of field: PlaydateTilemap::getSize"][::core::mem::offset_of!(PlaydateTilemap, getSize) - 20usize];
	["Offset of field: PlaydateTilemap::getPixelSize"]
		[::core::mem::offset_of!(PlaydateTilemap, getPixelSize) - 24usize];
	["Offset of field: PlaydateTilemap::setTiles"][::core::mem::offset_of!(PlaydateTilemap, setTiles) - 28usize];
	["Offset of field: PlaydateTilemap::setTileAtPosition"]
		[::core::mem::offset_of!(PlaydateTilemap, setTileAtPosition) - 32usize];
	["Offset of field: PlaydateTilemap::getTileAtPosition"]
		[::core::mem::offset_of!(PlaydateTilemap, getTileAtPosition) - 36usize];
	["Offset of field: PlaydateTilemap::drawAtPoint"]
		[::core::mem::offset_of!(PlaydateTilemap, drawAtPoint) - 40usize];
};
#[repr(C)]
#[must_use]
pub struct PlaydateGraphics {
	...
	*/
	...
	<div class="content">
	<div class="paragraph">
	<p>Sets a mask image for the given <em>bitmap</em>. The set mask must be the same size as the target bitmap. Returns 1 on success, 0 on failure (i.e. if either bitmap is NULL or the sizes don’t match).</p>
	</div>
	</div>
	*/
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
	["Size of PlaydateGraphics"][::core::mem::size_of::<PlaydateGraphics>() - 276usize];
	...
	["Offset of field: PlaydateGraphics::getTextHeightForMaxWidth"]
		[::core::mem::offset_of!(PlaydateGraphics, getTextHeightForMaxWidth) - 256usize];
	["Offset of field: PlaydateGraphics::drawRoundRect"]
		[::core::mem::offset_of!(PlaydateGraphics, drawRoundRect) - 260usize];
	["Offset of field: PlaydateGraphics::fillRoundRect"]
		[::core::mem::offset_of!(PlaydateGraphics, fillRoundRect) - 264usize];
	["Offset of field: PlaydateGraphics::tilemap"][::core::mem::offset_of!(PlaydateGraphics, tilemap) - 268usize];
	["Offset of field: PlaydateGraphics::videostream"]
		[::core::mem::offset_of!(PlaydateGraphics, videostream) - 272usize];
};
...
*/
    #[doc(hidden)]
    pub vaFormatString: *const ::core::convert::Infallible,
    /**
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
	["Size of PlaydateSys"][::core::mem::size_of::<PlaydateSys>() - 196usize];
	...
	["Offset of field: PlaydateSys::delay"][::core::mem::offset_of!(PlaydateSys, delay) - 176usize];
	["Offset of field: PlaydateSys::getServerTime"]
		[::core::mem::offset_of!(PlaydateSys, getServerTime) - 180usize];
	["Offset of field: PlaydateSys::restartGame"][::core::mem::offset_of!(PlaydateSys, restartGame) - 184usize];
	["Offset of field: PlaydateSys::getLaunchArgs"]
		[::core::mem::offset_of!(PlaydateSys, getLaunchArgs) - 188usize];
	["Offset of field: PlaydateSys::sendMirrorData"]
		[::core::mem::offset_of!(PlaydateSys, sendMirrorData) - 192usize];
};
...
pub struct PlaydateSprite {
	...
	*/
	...
	<div class="content">
	<div class="paragraph">
	<p>Specifies a stencil image to be set on the frame buffer before the sprite is drawn. If <em>stencil</em> is NULL, the stencil is cleared. If <em>tile</em> is set, the stencil will be tiled. Tiled stencils must have width evenly divisible by 32.</p>
	</div>
	</div>
	*/
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
	["Size of PlaydateSprite"][::core::mem::size_of::<PlaydateSprite>() - 260usize];
	...
	["Offset of field: PlaydateSprite::setTilemap"]
		[::core::mem::offset_of!(PlaydateSprite, setTilemap) - 252usize];
	["Offset of field: PlaydateSprite::getTilemap"]
		[::core::mem::offset_of!(PlaydateSprite, getTilemap) - 256usize];
};
#[repr(u8)]
#[must_use]
#[cfg_attr(feature = "const-types", derive(::core::marker::ConstParamTy))]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
	["Size of PlaydateDisplay"][::core::mem::size_of::<PlaydateDisplay>() - 40usize];
	...
	["Offset of field: PlaydateDisplay::getRefreshRate"]
		[::core::mem::offset_of!(PlaydateDisplay, getRefreshRate) - 32usize];
	["Offset of field: PlaydateDisplay::getFPS"][::core::mem::offset_of!(PlaydateDisplay, getFPS) - 36usize];
};
#[repr(C)]
#[must_use]
pub struct Score {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
	["Size of PlaydateHttp"][::core::mem::size_of::<PlaydateHttp>() - 100usize];
	["Alignment of PlaydateHttp"][::core::mem::align_of::<PlaydateHttp>() - 4usize];
	...
	["Offset of field: PlaydateHttp::newConnection"]
		[::core::mem::offset_of!(PlaydateHttp, newConnection) - 4usize];
	["Offset of field: PlaydateHttp::retain"][::core::mem::offset_of!(PlaydateHttp, retain) - 8usize];
	["Offset of field: PlaydateHttp::release"][::core::mem::offset_of!(PlaydateHttp, release) - 12usize];
	["Offset of field: PlaydateHttp::setConnectTimeout"]
		[::core::mem::offset_of!(PlaydateHttp, setConnectTimeout) - 16usize];
	["Offset of field: PlaydateHttp::setKeepAlive"][::core::mem::offset_of!(PlaydateHttp, setKeepAlive) - 20usize];
	["Offset of field: PlaydateHttp::setByteRange"][::core::mem::offset_of!(PlaydateHttp, setByteRange) - 24usize];
	["Offset of field: PlaydateHttp::setUserdata"][::core::mem::offset_of!(PlaydateHttp, setUserdata) - 28usize];
	["Offset of field: PlaydateHttp::getUserdata"][::core::mem::offset_of!(PlaydateHttp, getUserdata) - 32usize];
	["Offset of field: PlaydateHttp::get"][::core::mem::offset_of!(PlaydateHttp, get) - 36usize];
	["Offset of field: PlaydateHttp::post"][::core::mem::offset_of!(PlaydateHttp, post) - 40usize];
	["Offset of field: PlaydateHttp::query"][::core::mem::offset_of!(PlaydateHttp, query) - 44usize];
	["Offset of field: PlaydateHttp::getError"][::core::mem::offset_of!(PlaydateHttp, getError) - 48usize];
	["Offset of field: PlaydateHttp::getProgress"][::core::mem::offset_of!(PlaydateHttp, getProgress) - 52usize];
	["Offset of field: PlaydateHttp::getResponseStatus"]
		[::core::mem::offset_of!(PlaydateHttp, getResponseStatus) - 56usize];
	["Offset of field: PlaydateHttp::getBytesAvailable"]
		[::core::mem::offset_of!(PlaydateHttp, getBytesAvailable) - 60usize];
	["Offset of field: PlaydateHttp::setReadTimeout"]
		[::core::mem::offset_of!(PlaydateHttp, setReadTimeout) - 64usize];
	["Offset of field: PlaydateHttp::setReadBufferSize"]
		[::core::mem::offset_of!(PlaydateHttp, setReadBufferSize) - 68usize];
	["Offset of field: PlaydateHttp::read"][::core::mem::offset_of!(PlaydateHttp, read) - 72usize];
	["Offset of field: PlaydateHttp::close"][::core::mem::offset_of!(PlaydateHttp, close) - 76usize];
	["Offset of field: PlaydateHttp::setHeaderReceivedCallback"]
		[::core::mem::offset_of!(PlaydateHttp, setHeaderReceivedCallback) - 80usize];
	["Offset of field: PlaydateHttp::setHeadersReadCallback"]
		[::core::mem::offset_of!(PlaydateHttp, setHeadersReadCallback) - 84usize];
	["Offset of field: PlaydateHttp::setResponseCallback"]
		[::core::mem::offset_of!(PlaydateHttp, setResponseCallback) - 88usize];
	["Offset of field: PlaydateHttp::setRequestCompleteCallback"]
		[::core::mem::offset_of!(PlaydateHttp, setRequestCompleteCallback) - 92usize];
	["Offset of field: PlaydateHttp::setConnectionClosedCallback"]
		[::core::mem::offset_of!(PlaydateHttp, setConnectionClosedCallback) - 96usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
	["Size of PlaydateTcp"][::core::mem::size_of::<PlaydateTcp>() - 64usize];
	["Alignment of PlaydateTcp"][::core::mem::align_of::<PlaydateTcp>() - 4usize];
	["Offset of field: PlaydateTcp::requestAccess"][::core::mem::offset_of!(PlaydateTcp, requestAccess) - 0usize];
	["Offset of field: PlaydateTcp::newConnection"][::core::mem::offset_of!(PlaydateTcp, newConnection) - 4usize];
	["Offset of field: PlaydateTcp::retain"][::core::mem::offset_of!(PlaydateTcp, retain) - 8usize];
	["Offset of field: PlaydateTcp::release"][::core::mem::offset_of!(PlaydateTcp, release) - 12usize];
	["Offset of field: PlaydateTcp::getError"][::core::mem::offset_of!(PlaydateTcp, getError) - 16usize];
	["Offset of field: PlaydateTcp::setConnectTimeout"]
		[::core::mem::offset_of!(PlaydateTcp, setConnectTimeout) - 20usize];
	["Offset of field: PlaydateTcp::setUserdata"][::core::mem::offset_of!(PlaydateTcp, setUserdata) - 24usize];
	["Offset of field: PlaydateTcp::getUserdata"][::core::mem::offset_of!(PlaydateTcp, getUserdata) - 28usize];
	["Offset of field: PlaydateTcp::open"][::core::mem::offset_of!(PlaydateTcp, open) - 32usize];
	["Offset of field: PlaydateTcp::close"][::core::mem::offset_of!(PlaydateTcp, close) - 36usize];
	["Offset of field: PlaydateTcp::setConnectionClosedCallback"]
		[::core::mem::offset_of!(PlaydateTcp, setConnectionClosedCallback) - 40usize];
	["Offset of field: PlaydateTcp::setReadTimeout"]
		[::core::mem::offset_of!(PlaydateTcp, setReadTimeout) - 44usize];
	["Offset of field: PlaydateTcp::setReadBufferSize"]
		[::core::mem::offset_of!(PlaydateTcp, setReadBufferSize) - 48usize];
	["Offset of field: PlaydateTcp::getBytesAvailable"]
		[::core::mem::offset_of!(PlaydateTcp, getBytesAvailable) - 52usize];
	["Offset of field: PlaydateTcp::read"][::core::mem::offset_of!(PlaydateTcp, read) - 56usize];
	["Offset of field: PlaydateTcp::write"][::core::mem::offset_of!(PlaydateTcp, write) - 60usize];
};
#[repr(C)]
#[must_use]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
	["Size of PlaydateNetwork"][::core::mem::size_of::<PlaydateNetwork>() - 28usize];
	["Alignment of PlaydateNetwork"][::core::mem::align_of::<PlaydateNetwork>() - 4usize];
	["Offset of field: PlaydateNetwork::http"][::core::mem::offset_of!(PlaydateNetwork, http) - 0usize];
	["Offset of field: PlaydateNetwork::tcp"][::core::mem::offset_of!(PlaydateNetwork, tcp) - 4usize];
	["Offset of field: PlaydateNetwork::getStatus"][::core::mem::offset_of!(PlaydateNetwork, getStatus) - 8usize];
	["Offset of field: PlaydateNetwork::setEnabled"]
		[::core::mem::offset_of!(PlaydateNetwork, setEnabled) - 12usize];
	["Offset of field: PlaydateNetwork::reserved"][::core::mem::offset_of!(PlaydateNetwork, reserved) - 16usize];
};
#[repr(C)]
#[must_use]
pub struct Playdate {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
	["Size of Playdate"][::core::mem::size_of::<Playdate>() - 40usize];
	...
	["Offset of field: Playdate::network"][::core::mem::offset_of!(Playdate, network) - 36usize];
};
#[repr(u8)]
#[must_use]
#[cfg_attr(feature = "const-types", derive(::core::marker::ConstParamTy))]
